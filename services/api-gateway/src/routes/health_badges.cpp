...
public:
    METHOD_LIST_BEGIN
        METHOD_ADD(HealthBadges::all,        "/v1/leaderboard/health",       drogon::Get);
        METHOD_ADD(HealthBadges::one,        "/v1/leaderboard/health/{id}",  drogon::Get);
        METHOD_ADD(HealthBadges::regression, "/v1/submissions/{id}/regression", drogon::Get);
    METHOD_LIST_END
