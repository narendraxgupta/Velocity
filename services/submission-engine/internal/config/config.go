...
type Config struct {
	...
	// push. Defaults true for the dev plain-HTTP registry; set false in
	// production so image layers can't be MITM'd.
...
func Load() (*Config, error) {
	...
	c.RegistryInsecure = optionalBool("VELOCITY_REGISTRY_INSECURE", true)
